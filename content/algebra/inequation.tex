...
我们在\autoref{sec:polynomial-power-theorem}中曾经利用多项式乘幂定理证明过中间的$A_n \geqslant G_n$，在\autoref{thm:mathematical-induction}中也曾经使用倒推形式的数学归纳法证明过这个不等式，所以在这一节我们使用另外的方法。
